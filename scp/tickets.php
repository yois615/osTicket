...
if($_POST && !$errors):
    ...
    if($ticket && $ticket->getId()) {
        ...
        $canAnswer = ($isManager || $role->hasPerm(Ticket::PERM_ANSWER)); //Check if Agent can mark as answered/unanswered
